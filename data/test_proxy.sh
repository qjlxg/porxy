...
if [ ! -f $lite_file_path ]; then
    ...
    #       "outputMode": 1  // 0: base64 1: pic path 2: no pic 3: json 4: txt
    echo '{"group":"job","speedtestMode":"all","pingMethod":"googleping","sortMethod":"rspeed","concurrency":180,"testMode":2,"subscription":"","timeout":5,"language":"en","fontSize":24,"theme":"rainbow","unique":true,"outputMode":4}' > $lite_file_config_path
